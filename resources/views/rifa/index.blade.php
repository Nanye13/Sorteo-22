    ...
    <div class="container-fluid">
        <div style="margin-bottom: 15px; text-align: center">
            <div class="d-grid gap-2 d-md-block">
                <a href="" type="button" class="btn btn-success btn-lg">Iniciar</a>
              </div>
        </div>
        <div class="card">
            <div class="card-body">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-10">
                                    <div class="card-body">
                                        ...
                                        {{-- <p style="font-family:Poppins">No. Empleado</p>
                                        <p style="font-family:Poppins">Nombre</p>
                                        <p style="font-family:Poppins">Dirección</p> --}}
                                    </div>
                                </div>
                            </div>
                        </div>
