...
<body>
    ...
    <table>
        <tr>
            ...
            <th>
                <h3>FISCALÍA GENERAL DEL ESTADO DE QUERÉTARO </h3>
    ...
    <table class="tabla" id="tabla">
        <tr id="tr1">
            {{-- <th id="th1">{{$direcciones}}</th> --}}
            <th id="th1">No. de empleado</th>
            <th id="th1">Nombre completo del empleado</th>
            <th id="th1">Dirección a la que pertenece</th>
            <th id="th1">Descripción del regalo</th>
        </tr>
        ...
        @for ($i = 0; $i < 2; $i++)
        <tr>
            <td>{{ json_encode($direcciones[$i]) }}</td>
            <
        </tr>
        @endfor
    </table>
