    ...
    <div class="container-fluid" style="background-color: transparent">
        <div style="margin-bottom: 15px; text-align: center;">
            <div class="d-grid gap-2 d-md-block">
                ...
                <a type="button" class="btn btn-bd-oro" onclick="location.href = '/resetGeneral'">Reset General</a>
                &nbsp;

                <a type="button" class="btn btn-bd-especial" onclick="location.href = '/resetEspecial'">Reset Especial</a>
